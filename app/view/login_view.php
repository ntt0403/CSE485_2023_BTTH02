...
<head>
    ...
    <link rel="stylesheet" href="../../../CSE485_2023_BTTH02/public/css/style_login.css">
    <link rel="stylesheet" href="../../../CSE485_2023_BTTH02/public/css/style_login.css">
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                        <a class="nav-link active" href="./login_view.php">Đăng nhập</a>
                        </li>
                    </ul>
                    <!-- gộp file seaech -->
                    <?php require_once('../controllers/search_login_controller.php'); ?>
                ...
                <div class="card-body">
                    <form action="index_view.php" method="post">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Login" name="dangnhap" class="btn float-end login_btn">
                        </div>
                    </form>
                </div>
