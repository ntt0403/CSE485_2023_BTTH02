<?php
    ...
    $songName = isset($_GET['song']) ? $_GET['song'] : 'default';
    
    $songController = new SongController();
    $songController->displaySong($songName);
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="../app/view/login_view.php">Đăng nhập</a>
                    </li>
                </ul>
        ...
        <div class="row">
                ...
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="detail.php?song=cayvagio" class="text-decoration-none">Cây, lá và gió</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="detail1.php?song=csmt" class="text-decoration-none">Cuộc sống mến thương</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="detail2.php?song=longme" class="text-decoration-none">Lòng mẹ</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="detail3.php?song=phoipha" class="text-decoration-none">Phôi pha</a>
                        </h5>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center my-title">
                            <a href="detail4.php?song=noitinhyeubatdau" class="text-decoration-none">Nơi tình yêu bắt đầu</a>
                        </h5>
                    </div>
                </div>
            </div>
